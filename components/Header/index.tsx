...
const Header = (props: {
  ...
  return (
    <Flex as="header" css={{ position: "sticky", top: "0" }} className="top-0 z-999 w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <Flex alignItems='center' justifyContent="space-between" className="flex-grow px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <Flex alignItems='center' gap="2" className="items-center gap-2 sm:gap-4 lg:hidden">
        ...
        <Flex alignItems='center' css={{gap: {base: '3', sm: "7"}}}>
          <Flex as="ul" alignItems='center' className="gap-2 2xsm:gap-4">
            {/* <!-- Dark Mode Toggler --> */}
            <DarkModeSwitcher />
            {/* <!-- Dark Mode Toggler --> */}
